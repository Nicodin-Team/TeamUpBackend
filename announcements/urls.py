...
from announcements.views import AnnnouncementViewSet, MyAnnouncementsAPIView, AnnouncementJoinView, AnnouncementJoinRequestActionView, ManagerListView, BestManagerView, AnnouncementJoinRequestListView
...
urlpatterns = [
    ...
    path('join-requests-action/<int:join_request_id>/<str:action>/', AnnouncementJoinRequestActionView.as_view(), name='announcement-join-requests-action'),
]
